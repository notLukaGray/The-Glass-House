  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'size', title: 'Size', type: 'string', options: { list: ['auto', 'small', 'medium', 'large', 'full', 'custom'] }, description: 'Set the max width of the text. Example: "small" (max-w-xs), "medium" (max-w-md), "large" (max-w-lg), "full" (100% width). Use "custom" with Width/Max Width for advanced sizing.', hidden: ({ parent }: { parent: unknown }) => (parent as Record<string, unknown>)?.fullBleed },
