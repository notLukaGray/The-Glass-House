  ...
  fields: [
    {
      ...
      title: "Title",
      type: "string",
      initialValue: "Localization Foundation",
      readOnly: true,
      hidden: true,
    },
    {
    ...
    },
    {
      ...
      type: "array",
      description: "Add languages that will be available throughout the system",
      of: [
        {
          type: "object",
          fields: [
      ...
      validation: (rule: Rule) =>
        rule.custom((languages: Array<{ code: string; enabled: boolean }>) => {
...
export default foundationLocalization;
