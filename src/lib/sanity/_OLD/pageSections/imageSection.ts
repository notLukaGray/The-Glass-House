    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "localeString",
          description:
            'Overrides the asset description. Used for the image alt attribute (accessibility). Example: "A panoramic view of a mountain range at sunset."',
        },
        {
          name: "altCaption",
          title: "Alt Caption",
          type: "localeString",
          description:
            'Overrides the asset caption. Shown below the image. Example: "A beautiful sunset over the mountains."',
        },
        {
          name: "linkUrl",
          title: "Link URL",
          type: "string",
          description:
            'Optional. Make the image a link. Example: "https://example.com"',
        },
        {
          name: "hideOnMobile",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          title: "Overlay Color",
          type: "string",
          description: 'Color overlay on top of the image. Example: "#000".',
        },
        {
          name: "overlayOpacity",
          title: "Overlay Opacity",
          type: "number",
          description: "Opacity for the overlay color (0 to 1).",
          hidden: ({ parent }: { parent: unknown }) =>
            !(parent as Record<string, unknown>)?.overlayColor,
        },
        {
          ...
          type: "string",
          description:
            'Background color for the image container. Example: "#fff", "rgba(0,0,0,0.1)".',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: "boolean",
          description:
            "If true, image stretches edge-to-edge (ignores page padding/margins).",
        },
        {
          name: "size",
          title: "Size",
        ...
        },
        {
          ...
          description:
            'Set the aspect ratio of the image. Example: "16:9" for widescreen, "1:1" for square. Use "auto" for natural image ratio.',
        },
        {
          name: "alignment",
          title: "Alignment",
      ...
      fields: [
        {
          ...
          description:
            'How the image should fit its container. "cover" crops, "contain" letterboxes, "fill" stretches.',
        },
        {
          name: "margin",
          title: "Margin",
          type: "string",
          description: 'Custom margin. Example: "2rem", "32px".',
        },
        {
          name: "padding",
          title: "Padding",
          type: "string",
          description: "Custom padding inside the image container.",
        },
        {
          name: "maxWidth",
          title: "Max Width",
          type: "string",
          options: { list: ["none", "sm", "md", "lg", "xl", "2xl", "full"] },
          description:
            'Set a maximum width for the image. Example: "lg" (max-w-lg), "full" (100% width).',
        },
        {
          name: "maxHeight",
          title: "Max Height",
          type: "string",
          description:
            'Set a maximum height for the image. Example: "200px", "30vh".',
        },
      ],
    },
  ],
