      ...
      of: [
        {
          type: 'object',
          fields: [
            { name: 'company', title: 'Company', type: 'localeString', validation: (rule: Rule) => rule.required() },
          ...
          preview: {
            ...
            prepare({ company }: { company?: any }) {
              let displayTitle = (company && company.en) || company || 'Untitled';
              return {
                title: displayTitle
              };
            }
