const buttonRowSection = {
  ...
  preview: {
    ...
    prepare({ buttons }: { buttons?: any }) {
      let displayTitle = (buttons && buttons[0] && buttons[0].label && (buttons[0].label.en || buttons[0].label)) || 'Untitled';
      return {
        title: `Component: Button Row/CTA Section | Title: ${displayTitle}`,
      };
    }
  }
}
