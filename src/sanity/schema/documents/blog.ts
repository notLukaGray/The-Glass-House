...
const blog = {
  ...
  type: 'document',
  fields: [
    { name: 'title', title: 'Blog Title', type: 'localeString', validation: (rule: Rule) => rule.required() },
    ...
    { name: 'seo', title: 'SEO', type: 'seo' },
    {
      ...
      description: 'Add, remove, and drag to order content sections for this blog post.'
    }
  ]
}
