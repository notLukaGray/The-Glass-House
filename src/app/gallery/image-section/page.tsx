    ...
    <div className="container mx-auto p-8 space-y-12">
      ...
      <section className="mb-12">
        ...
        <div className="bg-white p-4">
          <ImageSection image={testImage} width="300px" height="150px" advanced={{ boxShadow: 'xl' }} />
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <div><div className="font-mono text-xs mb-1">advanced: hideOnMobile=true</div><ImageSection image={testImage} advanced={{ hideOnMobile: true }} /></div>
          <div><div className="font-mono text-xs mb-1">advanced: hideOnDesktop=true</div><ImageSection image={testImage} advanced={{ hideOnDesktop: true }} /></div>
        </div>
      </section>
