...
export default function TestThemePage() {
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-lg text-red-500">Error loading settings: {error.message}</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen p-8 transition-colors duration-300" style={{ backgroundColor: themeColors?.background }}>
      <ThemeToggle />
      
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8" style={{ color: themeColors?.text }}>
          Theme Test Page
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-semibold" style={{ color: themeColors?.text }}>
              Site Settings
            </h2>
        ...
        <div className="mt-12 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-base" style={{ color: themeColors?.text }}>
              This is a sample paragraph to test the typography settings. The font should be applied based on the settings from Sanity.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 space-y-4">
          ...
          <div className="space-y-4">
            {Object.entries(settings?.theme.spacing.spacingScale || {}).map(([key, value]) => (
